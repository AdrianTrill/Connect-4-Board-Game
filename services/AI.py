...
class AI:
    ...
    # This function checks if the game has been won by a certain player
    @staticmethod
    def winning_move(board: Board, player: int):
    ...
    @staticmethod
    def get_next_open_row(board: Board, col: int):
        for row in range(HEIGHT):
    ...
    @staticmethod
    def is_valid_location(board: Board, col: int):
